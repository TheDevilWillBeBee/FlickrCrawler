...
def fetch_urls(args):
    ...
    elif os.path.exists(os.path.join(args.out, f"{args.tag}/meta.json")):
    ...
    while start_date < datetime.date.today():
        ...
        kwargs = {
            ...
            'extras': 'url_o,owner_name,license,date_upload,tags,id,machine_tags',  # color_codes doesn't work anymore
